...
cd "$GO_REF"
go test ./internal/codegen/ -run 'TestM5CodegenFieldDefaults|TestM5CodegenMethodOverloading|TestM5CodegenPubMethodWithInterface|TestClassMethodExplicitReturnRecord' -count=1
